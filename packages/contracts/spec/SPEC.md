<!--
  Vendored verbatim from the Open Knowledge Format reference repository.
  ...
  License: Apache-2.0 (c) Google LLC - included under its terms.
           Full text: ./LICENSE-APACHE-2.0.txt

  This is the normative reference for every OKF bundle in this setup.
  Do not edit. To update, re-fetch from the source above at a newer commit
  and change the Commit line.
-->
