...
- `okf-local-mcp`: the local stdio and loopback HTTP MCP server, private to this
  repository. It is never published: it runs from a checkout on the machine that
  owns the bundle.
